...
var Rodm = module.exports = function() {
	this.schemas = {};
	this.models = {};
...
inherits(Rodm, EventEmitter);

Rodm.prototype.connect = function() {
	var defaults = {
		resources: {
...
Rodm.prototype.getModel = function(modelName) {
	return this.models[modelName];
};
Rodm.prototype.addModel = function(modelName, model) {
	return this.models[modelName] = model;
};
Rodm.prototype.hasModel = function(modelName) {
    return this.models.hasOwnProperty(modelName);
};
Rodm.prototype.hasSchema = function(schemaName) {
	return this.schemas.hasOwnProperty(schemaName);
};
Rodm.prototype.registerSchema = function(modelName, schemaFn) {
	return this.schemas[modelName] = schemaFn;
};

Rodm.prototype.model = function(name, schemaFn) {
