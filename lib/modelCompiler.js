...
var ModelDefinition = function(sukeru, modelName,schemaFn) {
	this.sukeru = sukeru;
...
ModelDefinition.prototype.compile = function(fn) {
    ...
    // Bucket definition
    var bucket = this.sukeru.db.bucket(this.bucketName || this.schema.name);
    ...
    model.prototype.sukeru = model.sukeru = this.sukeru;
...
var ModelCompiler = module.exports = function(sukeru) {
	this.sukeru = sukeru;
};


ModelCompiler.prototype.compile = function(modelName, schemaFn) {
	var modelDef = new ModelDefinition(this.sukeru, modelName);
